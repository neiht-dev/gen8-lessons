...
<svelte:head>
	<title>NGỮ PHÁP TIẾNG ANH VÀO LỚP 6 - GLOBAL SUCCESS</title>
</svelte:head>

<div class="container mx-auto px-4 py-8">
	<RoadmapHeader title="NGỮ PHÁP TIẾNG ANH VÀO LỚP 6 - GLOBAL SUCCESS" />
	...
	<main>
					...
					<tr class="hover:bg-base-300">
						...
						<td>
							<div class="flex flex-col justify-center gap-0">
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-lesson-1.html"
									class="link link-primary">Bài giảng</a
								><br />
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-worksheets-1.html"
					...
					<tr class="hover:bg-base-300">
						...
						<td>
							<div class="flex flex-col justify-center gap-0">
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-lesson-2.html"
									class="link link-primary">Bài giảng</a
								><br />
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-worksheets-2.html"
									class="link link-primary">Bài tập</a
								>
							</div>
						</td>
					...
					<tr class="hover:bg-base-300">
						...
						<td>
							<div class="flex flex-col justify-center gap-0">
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-lesson-3.html"
									class="link link-primary">Bài giảng</a
								><br />
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-worksheets-3.html"
									class="link link-primary">Bài tập</a
								>
							</div>
						</td>
					...
					<tr class="hover:bg-base-300">
						...
						<td>
							<div class="flex flex-col justify-center gap-0">
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-lesson-4.html"
									class="link link-primary">Bài giảng</a
								><br />
								<a
									target="_blank"
									href="/lessons/pre-gs6/pre-gs6-worksheets-4.html"
									class="link link-primary">Bài tập</a
								>
							</div>
						</td>
		...
		<div class="grid gap-4">
			<div class="alert alert-info">
				<div>
					<span><strong>Kiểm tra:</strong> Buổi 6 – Danh từ, mạo từ, đại từ</span>
				</div>
			</div>
			<div class="alert alert-info">
				<div>
					<span><strong>Kiểm tra:</strong> Buổi 12 – Trạng từ, động từ, tính từ</span>
				</div>
			</div>
			<div class="alert alert-info">
				<div>
					<span
						><strong>Kiểm tra:</strong> Buổi 20 – Các loại từ, cấu trúc câu, sở hữu</span
					>
				</div>
			</div>
