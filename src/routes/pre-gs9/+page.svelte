...
<svelte:head>
	<title>NGỮ PHÁP TIẾNG ANH VÀO LỚP 9 - GLOBAL SUCCESS</title>
</svelte:head>

<div class="container mx-auto px-4 py-8">
	<RoadmapHeader title="NGỮ PHÁP TIẾNG ANH VÀO LỚP 9 - GLOBAL SUCCESS" />
					...
					<tr class="hover:bg-base-300">
						...
						<td>
							<div class="flex flex-col justify-center gap-0">
								<a
									target="_blank"
									href="/lessons/pre-gs9/pre-gs9-lesson-1.html"
									class="link link-primary">Bài giảng</a
								><br />
								<a
									target="_blank"
									href="/lessons/pre-gs9/pre-gs9-worksheets-1.html"
					...
					<tr class="hover:bg-base-300">
						...
						<td>
							<div class="flex flex-col justify-center gap-0">
								<a
									target="_blank"
									href="/lessons/pre-gs9/pre-gs9-lesson-3.html"
									class="link link-primary">Bài giảng</a
								><br />
								<a
								target="_blank"
								href="/lessons/pre-gs9/pre-gs9-worksheets-3.html"
								class="link link-primary">Bài tập</a
							>
							</div>
						</td>
					...
					<tr class="hover:bg-base-300">
						...
						<td>
							<div class="flex flex-col justify-center gap-0">
								<a
									target="_blank"
									href="/lessons/pre-gs9/pre-gs9-lesson-4.html"
									class="link link-primary">Bài giảng</a
								><br />
